...
import {classNames,svgFillColors,svgPaths} from "./AlertSeverity"
...
const Alert = ({timeout,handleDismiss,message,severity}: Props) => {
...
const AlertsWrapper = ({children}:Children) => {
    return (
      <div className="fixed top-0 right-0 p-4 z-9999 pointer-events-none max-w-sm min-w-fit w-full">
        {children}
      </div>
    );
};
