...
const Sidebar = ({ sidebarOpen, setSidebarOpen,userRole }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#546DE5] duration-300 ease-linear lg:static lg:translate-x-0 ${
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {
                ...
                (
                  ...
                  <NavLink
                    to="/dashboard"
                    className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#F16A6A] ${
              ...
              }
              {
                ...
                (
                  <li>
                  <NavLink
                    to="/mri-visualization"
                    className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#F16A6A] ${
                      pathname.includes('mri-visualization') ?
                      'bg-[#F16A6A]' :'bg-[#AAB6F2]'
                    }`}
                  >
                    <svg
              ...
              }
              {
                ...
                (
                  ...
                  <NavLink
                    to="/mri-segmentation"
                    className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#F16A6A]  ${
                      pathname.includes('mri-segmentation') ?
                      'bg-[#F16A6A]' :'bg-[#AAB6F2]'
                    }`}
                  >
                    <svg
              ...
              }
              {
                ...
                (
                  ...
                  <NavLink
                    to="/tumor-analysis"
                    className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#F16A6A]  ${
                      pathname.includes('tumor-analysis') ?
                      'bg-[#F16A6A]' :'bg-[#AAB6F2]'
                    }`}
                  >
                    <svg
